...
- 个人资料：头像链接、邮箱通知、密码修改、团队信息、成员刷题数据、训练画像、训练周报、成就徽章、最近 30 天总结、各平台题数/提交数和 OJ 同步状态。
...
- 成就徽章：根据总 AC、本周 AC、本月 AC、活跃天数、连续训练、多平台覆盖、深夜提交比例和 AC 率自动点亮徽章。
- 团队训练看板：在个人资料页团队卡中展示团队本周 AC、本月 AC、活跃成员、本周贡献条和本周火力位。
- 训练周报：展示近 7 天 AC、提交、活跃天数、较上周变化、主要活跃平台和规则型训练建议。
